...
class GoogleSheet():
    ...
    # write dataframe to google sheet (append)
    def writeRecord(self, df_newRecord):
    ...
    def replaceRecord(self, df_newRecord):
        self.worksheet.update([df_newRecord.columns.values.tolist()] + df_newRecord.values.tolist())
